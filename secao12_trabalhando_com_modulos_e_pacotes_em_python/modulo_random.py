...
# usando módulos integrados do python
...
# OBS: Ao realizar o import de todo o módulo, todas as funções, atributos, classes
# e propriedades que estiverem dentro do módulo ficaraçõ disponíveis (Ficarão em Memória).
# Caso você saiba quais funções você precisa utilizar deste módulo, então esta não seria 
# a forma ideal de utilização. Nós veremos uma forma melhor na Forma 2.

print(random.random())
#OBS: Veja que para utilizar a função random() do pacote random, nós colocamos o nome do 
# pacote e o nome da função, separados por ponto.

# OBS: Não confunda a função random() com o pacote random. Pode parecer confuso, mas a 
# função random() é apenas uma função dentro do módulo random.
...
# Gerandor de apostas para a mega-sena

for i in range(6):
    print(randint(1, 61), end=', ') #começa em 1 e vai até 60


# choice() -> Mostra um valor aleatório ente um iterável

from random import choice
jogadas = ['pedra','papel','tesoura']

print(choice(jogadas))
print(choice('Dennis Augusto'))
