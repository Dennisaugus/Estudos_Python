...
print(list(zip1)) # Resultado -> [(1, 4, 'a'), (2, 5, 'b'), (3, 6, 'c')]
zip1 = zip(lista1,lista2,'abc')
print(tuple(zip1)) # Resultado -> ((1, 4, 'a'), (2, 5, 'b'), (3, 6, 'c'))
zip1 = zip(lista1,lista2,'abc')
print(set(zip1)) # Resultado -> {(2, 5, 'b'), (3, 6, 'c'), (1, 4, 'a')}
zip1 = zip(lista1,lista2)
print(dict(zip1)) # Resultado -> {1: 4, 2: 5, 3: 6}
...
print(list(zip1))
zip1 = zip(lista2,lista3,lista1)


# Podemos utilizar iferentes iteráveis com zip
